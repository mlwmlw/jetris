...
public class GtkTextUI {

    /**
     * Creates the object to use for a caret for all of the Gtk
     * text components.  The caret is rendered as an I-beam on Gtk.
     *
     ...
     */
    public static class GtkCaret extends DefaultCaret implements UIResource {
    ...
    /**
     * Default bindings all keymaps implementing the Gtk feel.
     */
