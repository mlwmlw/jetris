/*
 * @(#)GtkDesktopIconUI.java	1.2 00/01/12
 *
 ...
 * @author Rich Schiavi
 */
public class GtkDesktopIconUI extends BasicDesktopIconUI
{
	...
	GtkInternalFrameTitlePane titlePane = 
            new GtkInternalFrameTitlePane(frame);
        systemMenu = titlePane.getSystemMenu();
        GtkBorders.FrameBorder border = new GtkBorders.FrameBorder(desktopIcon);
	...
	JInternalFrame frame;
        ...
        public void paint(Graphics g) {
            ...
            // draw text -- clipping to truncate text like CDE/Gtk
